...
+(NSNotificationName _Nonnull ) refreshDockButtonNotification;

+(NSNotificationName _Nonnull ) dockCachedStatusNotification;
//+(NSNotificationName _Nonnull ) dockLockedNotification;

+(NSNotificationName _Nonnull ) firmwareUpdatedNotification;

-(void) SDC_DidConnect:(NSNotification*)notification; //JSL 15Feb24
+(void) addAccessoryDockSpecial:(LilitabAccessory*)acc; //JSL 15Feb24
////////////////////////////////////////////////////////////////////////////////
