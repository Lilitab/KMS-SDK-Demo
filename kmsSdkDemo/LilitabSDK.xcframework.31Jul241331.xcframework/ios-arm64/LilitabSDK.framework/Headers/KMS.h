...
-(void)kmsDockEvent:(NSString*)dockStatus;
...
-(void) addKMSEventDelegate:(NSObject<KMSEventDelegate>*)foo;
-(void) removeKMSEventDelegate:(NSObject<KMSEventDelegate>*)foo;

- (void)signalDelegateForDockEvent:(NSString*)statusMsg;
- (void)signalDelegateForDockStatusUpdate:(NSDictionary*)dict;

@property(nonatomic, weak)id <KMSEventDelegate> kmsEventsDelegate;
